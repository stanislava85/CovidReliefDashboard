...
def graph():
	...
	color = ("red", "purple")
	ax.barh(ticks, totals_boro["POPULATION"],label='Population (millions)',color="#D5573B")
	ax.barh(ticks, totals_boro["CASE_COUNT"], label='Case Count (millions)', color="#F1A208")
